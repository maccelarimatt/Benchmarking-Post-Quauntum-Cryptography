...
def main(
    ...
    export: str = "results/mayo_summary.json",
    export_raw: str = "",
    ...
    """
    Run MAYO signature micro-bench (keygen/sign/verify).
    """
    summary = run_sig("mayo", runs, message_size, cold=cold)
    _opts = {
    ...
    if export_raw:
        export_trace_sig("mayo", message_size, export_raw)
    if print_json:
