// Dilithium signature demo using liboqs
...
static const char *pick_alg_from_arg(const char *arg) {
    if (arg == NULL) return OQS_SIG_alg_dilithium_3; // sensible default
    if (strcasecmp(arg, "dilithium2") == 0 || strcasecmp(arg, "dilithium-2") == 0) return OQS_SIG_alg_dilithium_2;
    if (strcasecmp(arg, "dilithium3") == 0 || strcasecmp(arg, "dilithium-3") == 0) return OQS_SIG_alg_dilithium_3;
    if (strcasecmp(arg, "dilithium5") == 0 || strcasecmp(arg, "dilithium-5") == 0) return OQS_SIG_alg_dilithium_5;
...
int main(int argc, char *argv[]) {
    ...
    printf("OQS Dilithium demo (alg=%s)\n", alg_name);
